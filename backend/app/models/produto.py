...
class Produto(Base):
    ...
    capacidade: Mapped[str] = mapped_column(String(40), default="", nullable=False)
    modelo: Mapped[str] = mapped_column(String(60), default="", nullable=False)
    peso: Mapped[str] = mapped_column(String(40), default="", nullable=False)
    alca: Mapped[str] = mapped_column(String(3), default="nao", nullable=False)
